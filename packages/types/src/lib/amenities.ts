/**
 * Facilități (Amenities) — listă partajată pentru întreaga platformă Domaris/RIVA
 *
 * Folosită de mobile, frontend și backend pentru a asigura consistența datelor.
 */
...
// ============================================================================
// AMENITY IDs (literal union — util pentru validare DTO)
// ============================================================================
...
/** Toate id-urile de facilități, ca array constant */

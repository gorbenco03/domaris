...
export default function EditPropertyPage() {
    ...
    useEffect(() => {
        // Mock data loading - in production, this would fetch from backend
        ...
        if (id) {
            const property = mockProperties[String(id)];
            if (property) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Mock update - in production, this would send to backend
        toast({
            title: "Success",
